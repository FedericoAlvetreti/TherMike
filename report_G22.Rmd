...
![*Fig. 1*. Density and Viscosity vs temperature](IMG\\density_viscosity.png){width=50%}
...
![*Fig. 2*. Hot and Cold water pouring spectrograms](IMG\HOTvsCOLD_spectograms.png){width=50%}
...
![*Fig. 3*. Extracted features for hot and cold water](IMG\\features3.png){width=90%}

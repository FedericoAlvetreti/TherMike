...
csl: journal-of-information-technology.csl
header-includes:
  - \usepackage{fancyhdr}
  - \usepackage{makeidx}
  - \makeindex
...
![*Fig. 1*. Density and Viscosity vs temperature](C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\density_viscosity.png){width=50%}
...
![*Fig. 2*. Hot and Cold water pouring spectrograms](C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\HOTvsCOLD_spectograms.png){width=50%}
...
![*Fig. 3*. Extracted features for hot and cold water](C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\features3.png){width=50%}

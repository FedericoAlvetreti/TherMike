...
Let's start from a premise: it makes sense to think you can determine the water temperature by the sound it makes while poured.
...
```{r,echo=F}
knitr::include_graphics("C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\density_viscosity.png")
```
...
Unfortunately, by looking at the literature [1] it turns out that there there is not such a remarkable difference in the values of the frequencies and that the trends of the frequency lines are similar at different temperatures.


```{r,echo=F}
knitr::include_graphics("C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\HOTvsCOLD_spectograms.png")
```
...
In the literature [2] many attempts have been made to extract timbre features.
...
```{r,echo=F}
knitr::include_graphics("C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\features3.png")
```
+
...
```{r,echo=F}
knitr::include_graphics("C:\\Users\\ASUS\\OneDrive\\Data Science_MasterDegree\\2nd year\\StatLearning\\TerMike\\img1.png")
```
